...
namespace CyberSecurityBot.Services
{
    internal class ChatBot
    {
        ...
        public ChatBot(ConsoleUI uiobject)
        {
            ui = uiobject;
        ...
        {
            ui.WriteLine($"hello {username}! Ask me about cybersecurity.");
            ui.WriteLine($"type 'help' to see what I can do");
            ui.WriteLine($"type 'exit' to close the chatbot");
